...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \begin{align}
                f(x) &= \sqrt{ 1 + x^3 } \text{ and } f(f^{-1}(x)) = x \\
                \implies \sqrt{1 + (f^{-1}(x))^3 } &= x  \\
                \implies f^{-1}(x) &= (x^2 - 1) ^ {1/3} \\
                \implies (f^{-1}(x))' &= \frac{1}{3}( x^2 - 1 )^{-2/3} 2x
            \end{align}
        ...
        Using inverse function theorem $(f^{-1})'(f(x)) = \frac{1}{f'(x)}$.

        \begin{solution}

            \begin{align}
                (f^{-1})'(f(x)) &= \frac{1}{f'(x)} \\
                                &= \frac{2f(x)}{ 3x^2 } = \frac{ 2f(x)}{
                3(f^2(x)-1)^{2/3} } \\
                \implies (f^{-1})'(a) &= \frac{2a}{3(a^2-1)^{2/3}}
            \end{align}

            Which is same as equation (15).
